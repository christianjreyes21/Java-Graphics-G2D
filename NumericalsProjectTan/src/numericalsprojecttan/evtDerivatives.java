...
public class evtDerivatives extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("EVT for Derivatives (Tan, Sabrina) 2017");
...
//System.out.println(z1);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        y = topValue / bottomValue;

        System.out.println(y);
        
        ExprEvaluator util = new ExprEvaluator();
        IExpr result = util.evaluate("D("+ functionName.getText() +",x)");
        derived.setText(result+"="+y);
        //IExpr result = util.evaluate("Solve(2x+4==78, x)");
        result = util.evaluate("Solve("+ result +"== "+y+", x)");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(evtDerivatives.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new evtDerivatives().setVisible(true);
            }
        });
    }
